...
export class HistoryFilterComponent implements OnDestroy, AfterViewInit {
  ...
  ngAfterViewInit() {
    this.start = MaterialService.initDateFilter(this.startRef, this.validate.bind(this));
    this.end = MaterialService.initDateFilter(this.endRef, this.validate.bind(this))
  }
